...
# -----------------------------
# Specify path to IN header file inlgeo2020.pl downloaded from https://www2.census.gov/programs-surveys/decennial/2020/data/01-Redistricting_File--PL_94-171/
# -----------------------------
header_file_path <- "c:/CONGRESSIONAL_DISTRICTING/ingeo2020.pl"
...
write.table(x,file="c:/CONGRESSIONAL_DISTRICTING/IN_Blkgrps.txt",sep=",",row.names=FALSE,col.names=TRUE)
