...
# -----------------------------
# Specify path to PA header file pageo2020.pl downloaded from https://www2.census.gov/programs-surveys/decennial/2020/data/01-Redistricting_File--PL_94-171/
# -----------------------------
header_file_path <- "c:/CONGRESSIONAL_DISTRICTING/pageo2020.pl"
...
write.table(x,file="c:/CONGRESSIONAL_DISTRICTING/PA_Blkgrps.txt",sep=",",row.names=FALSE,col.names=TRUE)
