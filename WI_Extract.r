...
# -----------------------------
# Specify path to WI header file wigeo2020.pl downloaded from https://www2.census.gov/programs-surveys/decennial/2020/data/01-Redistricting_File--PL_94-171/
# -----------------------------
header_file_path <- "c:/CONGRESSIONAL_DISTRICTING/wigeo2020.pl"
...
write.table(x,file="c:/CONGRESSIONAL_DISTRICTING/WI_Blkgrps.txt",sep=",",row.names=FALSE,col.names=TRUE)
